...
PACKS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "review_notes": "Phase 161 clinician decision: revise and keep draft. Adult-only for now. Do not promote until clinician review approves antibiotic/watchful-waiting wording, follow-up timing, pediatric exclusion, perforation/tube boundary, recurrent disease boundary, and ENT-directed plan handling.",
