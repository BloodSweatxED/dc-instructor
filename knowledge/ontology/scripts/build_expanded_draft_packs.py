...
PACKS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "review_notes": "Phase 202 clinician review applied. Keep draft-only until final approval after revised runtime stress. Broad ear pain and broad ear infection remain out of runtime terms.",
        "summary": "Your clinician diagnosed a middle ear infection called acute otitis media.",
        "found": "Your clinician documented no mastoiditis concern, no ear tubes or perforated eardrum concern, no ear canal infection pathway, and no other ear red flags in this discharge plan.",
        "home": [
        ...
        "follow": "Follow up with primary care, urgent care, or an ear clinician in 7 to 14 days, or sooner if symptoms are not improving, unless your clinician gave a different schedule.",
        "inclusion": [
    ...
    },
    {
        ...
        "review_notes": "Phase 203 clinician review applied. Keep draft-only until final approval after revised runtime stress. Requires clinician-documented wound readiness and wound follow-up plan.",
        "summary": "Your clinician checked your healing wound.",
        "found": "Your clinician documented the wound is healing as expected and did not document infection, wound opening, or another wound red flag.",
        "home": [
        ...
        "required_context": [
            {
                "id": "clinician_documented_wound_readiness",
                "terms": [
                    "clinician documented wound ready",
    ...
    },
    {
        ...
        "review_notes": "Phase 204 clinician review applied from multi-phenotype packet. Draft-only until final approval after runtime stress. No static tetanus or topical antibiotic language.",
        "summary": "Your clinician diagnosed a simple skin abrasion, skin tear, or skin avulsion.",
        "found": "Your clinician documented a superficial skin wound without a repair need, retained foreign body concern, deep structure injury, infection concern, or other wound red flag.",
        "home": [
        ...
        "follow": "Follow up with primary care, urgent care, wound clinic, or the ED in 2 to 3 days if the wound is not improving, or sooner if your clinician gave a specific schedule.",
        "inclusion": [
    ...
    },
    {
        ...
        "label": "Non-ankle sprain or strain with negative x-ray",
        "family": "musculoskeletal_injury",
        "condition_terms": [
            "non ankle sprain xray negative",
            "non ankle strain xray negative",
            "sprain strain non ankle xray negative",
        ...
        "review_notes": "Phase 205 clinician review applied from multi-phenotype packet. Highest-risk draft in this batch; keep draft-only until stress across knee, shoulder, wrist, elbow, and foot passes and clinician owner approves final promotion.",
        ...
        "exclusion": [
            ...
            "Inability to bear weight for lower-extremity injuries, pediatric growth plate pathway, or elderly/osteoporotic high-risk knee, shoulder, or wrist injury.",
        ],
        "must_not_miss": [
            "Occult fracture.",
            "Dislocation.",
