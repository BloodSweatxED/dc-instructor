...
PACKS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "found": "You came to the ED because your asthma got worse. We gave you breathing treatments and steroids. After treatment, you were breathing comfortably on your own and were safe to go home.",
        "home": ["Rest for the next 1-2 days and avoid hard exercise until your breathing feels normal.", "Stay away from things that trigger your asthma, like smoke, strong smells, cold air, and dust.", "Use your spacer if you have one.", "Start activity slowly as your breathing improves.", "Wash your hands and avoid sick contacts when you can."],
        "meds": ["Use your rescue inhaler as prescribed.", "Take the steroid course exactly as prescribed.", "Do not wait at home if your rescue inhaler is not helping."],
        ...
        "follow": "See your primary care doctor or asthma clinician within 3-5 days, or sooner if symptoms are not improving.",
