...
PACKS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "runtime_mode": "retired_product_layer_fallback_only",
        "review_notes": "Phase 168 retired this draft to product-layer fallback because no explicit final clinician approval was given for adult-only AOM ontology mode. Keep broad ear pain and broad ear infection out of runtime terms.",
        "summary": "Your clinician diagnosed a middle ear infection called acute otitis media.",
        "found": "Your discharge plan did not document mastoiditis, eardrum rupture, ear tube complication, ear canal infection, or another ear emergency today.",
        "home": [
        ...
        "follow": "Follow up on the schedule your clinician gave you, especially if symptoms are not improving.",
        "inclusion": [
    ...
    },
    {
        ...
        "runtime_mode": "retired_product_layer_fallback_only",
        "review_notes": "Phase 184 retired this draft to product-layer fallback because suture removal readiness, timing by body site, cosmesis, and specialist-directed wound plans require explicit clinician approval before ontology mode.",
        "summary": "Your clinician checked your healing wound today.",
        "found": "Your discharge plan did not document wound infection, the wound opening, or another wound emergency today.",
        "home": [
        ...
        "follow": "Follow up on the wound schedule your clinician gave you.",
        "inclusion": [
