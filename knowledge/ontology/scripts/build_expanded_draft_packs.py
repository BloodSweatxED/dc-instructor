...
PACKS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "review_status": "needs_review",
        "source_supported": True,
        "source_audit_notes": "MedlinePlus supports contact dermatitis as an irritant or allergic skin reaction after direct contact with a substance, avoidance of the trigger, moisturizers, clinician-directed topical therapy, and escalation for severe reactions, failure to improve, or infection signs. This draft keeps medication choices and steroid dosing out of static text.",
        "review_notes": "Phase 650-700 clinician review applied as revise-not-promote. Contact dermatitis is source-supported but still needs explicit clinician approval before ontology mode. Keep broad rash, hives/anaphylaxis, infection, mucosal/peeling rash, eye/genital involvement, pediatric pathway, pregnancy, and immunocompromise outside this draft.",
        "clinical_status": "draft_for_limited_uncomplicated_contact_dermatitis_review",
