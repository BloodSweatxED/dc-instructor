...
PACKS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "review_status": "needs_review",
        "source_supported": True,
        "source_audit_notes": "MedlinePlus and CDC support acute otitis media/middle-ear infection framing, ear pain and fever symptom education, clinician-directed observation or antibiotic decisions, and escalation for severe or worsening illness. These sources do not independently support ED-specific risk stratification, so runtime must require a clinician diagnosis and block mastoiditis, perforation, tube, otitis externa, trauma, foreign body, immunocompromise, and systemic illness concerns.",
        "review_notes": "Phase 155 draft only. Acute otitis media is source-supported for patient education, but antibiotic choice, watchful waiting, pediatric dosing, and mastoiditis boundary require EM clinician review before promotion.",
        "summary": "Your clinician diagnosed an ear infection called acute otitis media.",
        "found": "Your discharge plan did not document mastoiditis, eardrum rupture, ear canal infection, or another ear emergency today.",
        "home": [
        ...
        "follow": "Follow up with primary care, urgent care, or an ear clinician as instructed, especially if symptoms are not improving.",
        "inclusion": [
        ...
        "required_context": [
            ...
            },
            {
                ...
                "terms": [
                    ...
                    "no perforation tube trauma foreign body hearing loss facial weakness",
