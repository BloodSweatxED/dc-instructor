# Uncomplicated blepharitis without vision or orbital red flags

Phenotype ID: `blepharitis_uncomplicated_no_vision_or_orbital_red_flags`

Status: `reviewed`

## Inclusion Criteria

- Adult with clinician diagnosis or discharge impression of uncomplicated blepharitis.
...
- Orbital cellulitis.
- Periorbital cellulitis requiring separate plan.
- Corneal ulcer or keratitis.
- Acute glaucoma mimic.

## Primitive List

- `blepharitis_uncomplicated_no_vision_or_orbital_red_flags.diagnosis.diagnosis_summary.v1` | `diagnosis` | audit: source_supported, clinician_judgment_only, notes | unsafe modifiers: none
...
- `blepharitis_uncomplicated_no_vision_or_orbital_red_flags.home_care.home_care_1.v1` | `home_care` | audit: source_supported, notes | unsafe modifiers: none
- `blepharitis_uncomplicated_no_vision_or_orbital_red_flags.home_care.home_care_2.v1` | `home_care` | audit: source_supported, notes | unsafe modifiers: none
- `blepharitis_uncomplicated_no_vision_or_orbital_red_flags.home_care.home_care_3.v1` | `home_care` | audit: source_supported, notes | unsafe modifiers: none
...
- `blepharitis_uncomplicated_no_vision_or_orbital_red_flags.return_precautions.return_precaution_1.v1` | `return_precautions` | audit: source_supported, clinician_judgment_only, notes | unsafe modifiers: none
- `blepharitis_uncomplicated_no_vision_or_orbital_red_flags.return_precautions.return_precaution_2.v1` | `return_precautions` | audit: source_supported, clinician_judgment_only, notes | unsafe modifiers: none
- `blepharitis_uncomplicated_no_vision_or_orbital_red_flags.return_precautions.return_precaution_3.v1` | `return_precautions` | audit: source_supported, clinician_judgment_only, notes | unsafe modifiers: none
...
```text
DIAGNOSIS:
Your symptoms fit blepharitis, irritation and inflammation of the eyelids.

WHAT WE FOUND:
Your clinician diagnosed uncomplicated blepharitis. We did not find vision changes, severe eye pain, eye injury, or signs of a deeper infection around the eye today.

WHAT TO DO AT HOME:
- Use warm compresses as your clinician instructed.
- Clean the eyelid edges gently as instructed.
...
- Symptoms get much worse or do not improve with the plan you were given.
