...
- `cellulitis_uncomplicated_oral_antibiotics.what_we_found.reassuring_ed_assessment.v1` | `what_we_found` | audit: source_supported, clinician_judgment_only, unsafe_without_modifier | unsafe modifiers: immunocompromised, rapid_progression, diabetic_foot, bite_wound, near_eye_or_genitals, necrotizing_infection_concern, sepsis
...
- `cellulitis_uncomplicated_oral_antibiotics.medications.medication_guidance_1.v1` | `medications` | audit: source_supported, clinician_judgment_only, unsafe_without_modifier | unsafe modifiers: immunocompromised, rapid_progression, diabetic_foot, bite_wound, near_eye_or_genitals, necrotizing_infection_concern, sepsis
- `cellulitis_uncomplicated_oral_antibiotics.medications.medication_guidance_2.v1` | `medications` | audit: source_supported, clinician_judgment_only, unsafe_without_modifier | unsafe modifiers: immunocompromised, rapid_progression, diabetic_foot, bite_wound, near_eye_or_genitals, necrotizing_infection_concern, sepsis
...
- `cellulitis_uncomplicated_oral_antibiotics.follow_up.default_follow_up.v1` | `follow_up` | audit: source_supported, clinician_judgment_only, unsafe_without_modifier | unsafe modifiers: immunocompromised, rapid_progression, diabetic_foot, bite_wound, near_eye_or_genitals, necrotizing_infection_concern, sepsis
