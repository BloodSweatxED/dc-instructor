# Wrist abrasion without tendon injury or infection

Phenotype ID: `wrist_abrasion_no_tendon_or_infection`

Status: `reviewed`

## Inclusion Criteria

- Adult with clinician diagnosis or discharge impression of superficial wrist abrasion.
...
- `wrist_abrasion_no_tendon_or_infection.diagnosis.diagnosis_summary.v1` | `diagnosis` | audit: source_supported, clinician_judgment_only, notes | unsafe modifiers: none
- `wrist_abrasion_no_tendon_or_infection.what_we_found.reassuring_ed_assessment.v1` | `what_we_found` | audit: source_supported, clinician_judgment_only, unsafe_without_modifier, notes | unsafe modifiers: bite_wound, burn_or_chemical_wound, delayed_wound_presentation, dirty_wound, fever, high_pressure_injection_injury, immunocompromised, laceration_repair_needed, open_wound, pediatric_pathway, pregnancy, retained_foreign_body, secondary_skin_infection_concern, sepsis, specialist_directed_wound_plan, wound_infection_concern, hand_tendon_risk, joint_violation
- `wrist_abrasion_no_tendon_or_infection.home_care.home_care_1.v1` | `home_care` | audit: source_supported, notes | unsafe modifiers: none
- `wrist_abrasion_no_tendon_or_infection.home_care.home_care_2.v1` | `home_care` | audit: source_supported, notes | unsafe modifiers: none
- `wrist_abrasion_no_tendon_or_infection.home_care.home_care_3.v1` | `home_care` | audit: source_supported, notes | unsafe modifiers: none
...
- `wrist_abrasion_no_tendon_or_infection.return_precautions.return_precaution_1.v1` | `return_precautions` | audit: source_supported, clinician_judgment_only, notes | unsafe modifiers: none
- `wrist_abrasion_no_tendon_or_infection.return_precautions.return_precaution_2.v1` | `return_precautions` | audit: source_supported, clinician_judgment_only, notes | unsafe modifiers: none
- `wrist_abrasion_no_tendon_or_infection.return_precautions.return_precaution_3.v1` | `return_precautions` | audit: source_supported, clinician_judgment_only, notes | unsafe modifiers: none
...
```text
DIAGNOSIS:
You were treated for a wrist abrasion.

WHAT WE FOUND:
Your clinician diagnosed a superficial wrist abrasion. We did not find a deep wound, tendon injury, debris concern, or infection today.
