# Upper back strain without neurologic or trauma red flags

Phenotype ID: `upper_back_strain_uncomplicated_no_neuro_or_trauma_red_flags`

Status: `reviewed`

## Inclusion Criteria

- Adult with clinician diagnosis or discharge impression of uncomplicated upper back strain.
...
- `upper_back_strain_uncomplicated_no_neuro_or_trauma_red_flags.diagnosis.diagnosis_summary.v1` | `diagnosis` | audit: source_supported, clinician_judgment_only, notes | unsafe modifiers: none
...
- `upper_back_strain_uncomplicated_no_neuro_or_trauma_red_flags.home_care.home_care_1.v1` | `home_care` | audit: source_supported, notes | unsafe modifiers: none
- `upper_back_strain_uncomplicated_no_neuro_or_trauma_red_flags.home_care.home_care_2.v1` | `home_care` | audit: source_supported, notes | unsafe modifiers: none
- `upper_back_strain_uncomplicated_no_neuro_or_trauma_red_flags.home_care.home_care_3.v1` | `home_care` | audit: source_supported, notes | unsafe modifiers: none
...
- `upper_back_strain_uncomplicated_no_neuro_or_trauma_red_flags.return_precautions.return_precaution_1.v1` | `return_precautions` | audit: source_supported, clinician_judgment_only, notes | unsafe modifiers: none
- `upper_back_strain_uncomplicated_no_neuro_or_trauma_red_flags.return_precautions.return_precaution_2.v1` | `return_precautions` | audit: source_supported, clinician_judgment_only, notes | unsafe modifiers: none
- `upper_back_strain_uncomplicated_no_neuro_or_trauma_red_flags.return_precautions.return_precaution_3.v1` | `return_precautions` | audit: source_supported, clinician_judgment_only, notes | unsafe modifiers: none
...
```text
DIAGNOSIS:
Your symptoms fit an uncomplicated upper back strain.

WHAT WE FOUND:
Your clinician diagnosed a upper back strain. We did not find a fracture, tendon rupture, circulation problem, nerve problem, or another emergency problem today.
