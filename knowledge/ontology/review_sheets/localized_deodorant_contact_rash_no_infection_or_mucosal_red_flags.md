# Localized deodorant contact rash without infection or mucosal red flags

Phenotype ID: `localized_deodorant_contact_rash_no_infection_or_mucosal_red_flags`

Status: `reviewed`

## Inclusion Criteria

- Adult with clinician diagnosis or discharge impression of localized deodorant exposure skin reaction.
...
- `localized_deodorant_contact_rash_no_infection_or_mucosal_red_flags.diagnosis.diagnosis_summary.v1` | `diagnosis` | audit: source_supported, clinician_judgment_only, notes | unsafe modifiers: none
...
- `localized_deodorant_contact_rash_no_infection_or_mucosal_red_flags.home_care.home_care_1.v1` | `home_care` | audit: source_supported, notes | unsafe modifiers: none
- `localized_deodorant_contact_rash_no_infection_or_mucosal_red_flags.home_care.home_care_2.v1` | `home_care` | audit: source_supported, notes | unsafe modifiers: none
- `localized_deodorant_contact_rash_no_infection_or_mucosal_red_flags.home_care.home_care_3.v1` | `home_care` | audit: source_supported, notes | unsafe modifiers: none
...
- `localized_deodorant_contact_rash_no_infection_or_mucosal_red_flags.return_precautions.return_precaution_1.v1` | `return_precautions` | audit: source_supported, clinician_judgment_only, notes | unsafe modifiers: none
- `localized_deodorant_contact_rash_no_infection_or_mucosal_red_flags.return_precautions.return_precaution_2.v1` | `return_precautions` | audit: source_supported, clinician_judgment_only, notes | unsafe modifiers: none
- `localized_deodorant_contact_rash_no_infection_or_mucosal_red_flags.return_precautions.return_precaution_3.v1` | `return_precautions` | audit: source_supported, clinician_judgment_only, notes | unsafe modifiers: none
...
```text
DIAGNOSIS:
Your symptoms fit a localized skin reaction from deodorant exposure.

WHAT WE FOUND:
Your clinician diagnosed a localized deodorant exposure skin reaction. We did not find anaphylaxis, mucosal involvement, skin infection, or another rash emergency today.
