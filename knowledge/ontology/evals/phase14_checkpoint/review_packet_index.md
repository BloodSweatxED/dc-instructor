...
| `gastroenteritis_stable_hydrating` | reviewed | `review_sheets/gastroenteritis_stable_hydrating_v1_review_packet.md` | `medlineplus.viral_gastroenteritis`, `medlineplus.diarrhea_self_care` |
| `laceration_repaired_simple` | reviewed | `review_sheets/laceration_repaired_simple_v1_review_packet.md` | `medlineplus.cuts_puncture_wounds` |
| `lumbar_strain_no_red_flags` | reviewed | `review_sheets/lumbar_strain_no_red_flags_v1_review_packet.md` | `medlineplus.low_back_pain_acute`, `wikem.low_back_pain` |
| `minor_head_injury_no_red_flags` | reviewed | `review_sheets/minor_head_injury_no_red_flags_v1_review_packet.md` | `cdc.heads_up_concussion_symptoms`, `cdc.mild_tbi_aftercare` |
| `renal_colic_stable_no_infection` | reviewed | `review_sheets/renal_colic_stable_no_infection_v1_review_packet.md` | `medlineplus.kidney_stones_self_care` |
| `uncomplicated_cystitis_nonpregnant` | reviewed | `review_sheets/uncomplicated_cystitis_nonpregnant_v1_review_packet.md` | `cdc.uti_basics`, `medlineplus.uti_self_care` |
| `viral_pharyngitis_strep_negative` | reviewed | `review_sheets/viral_pharyngitis_strep_negative_v1_review_packet.md` | `cdc.sore_throat_basics`, `cdc.group_a_strep_pharyngitis` |
| `viral_uri_no_pneumonia` | reviewed | `review_sheets/viral_uri_no_pneumonia_v1_review_packet.md` | `medlineplus.common_cold`, `ahrq.common_cold_antibiotics` |
