...
OVERRIDES: dict[str, str] = {
    ...
    "cellulitis_uncomplicated_oral_antibiotics.what_we_found.reassuring_ed_assessment.v1": "You came to the ED for redness, pain, or swelling of the skin. Your exam fit cellulitis that can be treated at home. We did not find signs of a deeper emergency infection.",
    "cellulitis_uncomplicated_oral_antibiotics.home_care.home_care_1.v1": "Keep the area clean and dry.",
    "cellulitis_uncomplicated_oral_antibiotics.home_care.home_care_2.v1": "Raise the arm or leg above heart level as much as possible, including when sleeping.",
    "cellulitis_uncomplicated_oral_antibiotics.home_care.home_care_3.v1": "Mark the edge of the redness if your clinician asked you to. Take a phone photo of the marked border so you can tell if it is spreading.",
    ...
    "cellulitis_uncomplicated_oral_antibiotics.medications.medication_guidance_2.v1": "Use acetaminophen or ibuprofen only if it is safe for you and follow the label.",
    ...
    "cellulitis_uncomplicated_oral_antibiotics.follow_up.default_follow_up.v1": "Get rechecked in 48-72 hours. Redness and swelling can look worse during the first 24-48 hours before they start to improve.",
    ...
    "community_acquired_pneumonia_outpatient.what_we_found.reassuring_ed_assessment.v1": "You came to the ED with symptoms of a lung infection. Your oxygen level was safe, and it is safe to treat this at home.",
    ...
    "community_acquired_pneumonia_outpatient.home_care.home_care_2.v1": "Drink plenty of fluids unless your doctor has told you to limit them.",
    "community_acquired_pneumonia_outpatient.home_care.home_care_3.v1": "Warm liquids like tea with honey, broth, or warm water with lemon can soothe cough and keep you hydrated. Steam from a hot shower or steamy bathroom for 10-15 minutes can help loosen mucus.",
    "community_acquired_pneumonia_outpatient.home_care.home_care_4.v1": "Sleep with your head raised and use a cool-mist humidifier if dry air makes coughing worse. Avoid smoking, vaping, and smoke exposure while your lungs recover.",
    ...
    "community_acquired_pneumonia_outpatient.medications.medication_guidance_2.v1": "Use acetaminophen or ibuprofen only if it is safe for you and follow the label.",
    ...
    "community_acquired_pneumonia_outpatient.follow_up.default_follow_up.v1": "See your primary care doctor or clinic within 2-3 days, or sooner if symptoms are not improving. Most people start to feel better within 3-5 days of antibiotics, but full recovery can take 2-4 weeks.",
    ...
    "minor_head_injury_no_red_flags.what_we_found.reassuring_ed_assessment.v1": "You came to the ED after hitting your head. Your exam was reassuring. We did not find signs of bleeding in or around the brain.",
    ...
    "minor_head_injury_no_red_flags.home_care.home_care_3.v1": "Have someone stay with you or check on you tonight. They should be able to wake you up and make sure you are acting normally.",
    "minor_head_injury_no_red_flags.home_care.home_care_4.v1": "Screen time, loud places, and strenuous activity can worsen concussion symptoms. Symptoms like headache, dizziness, and fatigue can last days to weeks.",
    ...
    "minor_head_injury_no_red_flags.medications.medication_guidance_2.v1": "Do not take ibuprofen, naproxen, or aspirin after a head injury unless your clinician says it is safe.",
    ...
    "renal_colic_stable_no_infection.what_we_found.reassuring_ed_assessment.v1": "You came to the ED with flank pain or symptoms that fit a kidney stone. We did not find signs of infection or a dangerous blockage.",
    "renal_colic_stable_no_infection.home_care.home_care_1.v1": "Drink plenty of fluids. Aim for urine that is pale yellow. This helps flush the stone through.",
    "renal_colic_stable_no_infection.home_care.home_care_2.v1": "Use a urine strainer with every urination, including at night, if one was given.",
    "renal_colic_stable_no_infection.home_care.home_care_3.v1": "Save any passed stone if your clinician asked you to.",
    "renal_colic_stable_no_infection.home_care.home_care_4.v1": "Until you follow up, limit salt and animal protein, and avoid getting dehydrated.",
    ...
    "renal_colic_stable_no_infection.medications.medication_guidance_2.v1": "If tamsulosin was prescribed, it relaxes the ureter and may help the stone pass.",
    ...
    "renal_colic_stable_no_infection.follow_up.default_follow_up.v1": "Follow up with urology or primary care within 1-2 weeks. Most small stones pass on their own within 1-4 weeks.",
